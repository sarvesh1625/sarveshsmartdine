...
export default function MenuManager() {
  ...
  discounted_price:      itemForm.discounted_price && Number(itemForm.discounted_price) > 0
                           ? Number(itemForm.discounted_price)
                           : null,
  preparation_time_mins: Number(itemForm.preparation_time_mins) || 15,
  image_url:             itemForm.image_url || null,
  is_veg:                Boolean(itemForm.is_veg),
  is_combo:              Boolean(itemForm.is_combo),
  combo_items:           itemForm.is_combo && itemForm.combo_items?.length
                           ? itemForm.combo_items
                           : null,
  combo_savings:         itemForm.combo_savings ? Number(itemForm.combo_savings) : null,
  tags:                  itemForm.is_combo ? ['combo'] : null,
  name_te:               itemForm.name_te || null,
